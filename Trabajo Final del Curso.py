...
lab0 = Label(ventana,text='Ferreteria El Tornillo Feliz', font=("Arial",15), fg= "black", bg="lead")
lab0.place(x=170,y=10)

lab1 = Label(ventana, text='DNI: ',font=("Arial",10), fg="black", bg="lead")
lab1.place(x=40,y=50, height=25)
txt1 = Entry(ventana)
txt1.place(x=100, y=50, width=70, height=25)

lab2 = Label(ventana, text='APELLIDOS: ', font=("Arial",10), fg="black" , bg="lead")
lab2.place(x=20, y=90)
txt2 = Entry(ventana)
txt2.place(x=100,y=90, width=130, height=25)

lab3 = Label(ventana, text='NOMBRES: ' ,font=("Arial",10), fg="black" ,bg="lead")
lab3.place(x=300,y=90)
txt3 = Entry(ventana)
txt3.place(x=370,y=90, width=130, height=25)

lab4 = Label(ventana, text='DIRECCION: ', font=("Arial",10), fg="black", bg="lead")
lab4.place(x=20, y=130)
txt4 = Entry(ventana)
txt4.place(x=100, y=130, width=350, height=25)

lab5 = Label(ventana, text='TELELEFONO: ', font=("Arial",10), fg="black", bg="lead")
lab5.place(x=20, y=170)
txt5 = Entry(ventana)
txt5.place(x=100, y=170, width=350, height=25)

lab6 = Label(ventana, text='Codigo de producto', font=("Arial",11), fg="black", bg="lead")
lab6.place(x=20, y=210)

lab7 = Label(ventana, text='Descripcion', font=("Arial",11), fg="black", bg="lead")
lab7.place(x=160, y=210)

lab8 = Label(ventana, text='Unidad', font=("Arial",11), fg="black", bg="lead")
lab8.place(x=260, y=210)

lab9 = Label(ventana, text='Cantidad', font=("Arial",11), fg="black", bg="lead")
lab9.place(x=340, y=210)

lab10= Label(ventana, text='Precio', font=("Arial",11), fg="black", bg="lead")
lab10.place(x=430, y=210)

lab11 = Label(ventana, text='Subtotal', font=("Arial",11), fg="black", bg="lead")
...
btn = Button(ventana,text='Calcular Total', font=("Arial" ,11),commad = calcularST1, bg="black", fg="white")
btn.place(x=190, y=350)

lab12 = Label(ventana,text='Total: ', font=("Arial",11),fg="black",bg="white")
